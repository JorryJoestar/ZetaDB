...
const (
	EP_INITIALIZE_SYSTEM ExecutionPlanType = 1
...
func NewExecutionPlan(planType ExecutionPlanType, parameter []string, logicalPlanRoot *LogicalPlanNode) *ExecutionPlan {
